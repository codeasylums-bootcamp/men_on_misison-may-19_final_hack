...
app.post('/charge',(req, res) => {
	...
	.then(charge => res.sendfile(path.join(__dirname,'/views/success.html')));
});
...
app.get('/regtrainer.html',function(req,res){
   res.sendFile(path.join(__dirname,'/regtrainer.html'));
});
...
app.get('/logtrainer.html',function(req,res){
   res.sendFile(path.join(__dirname,'/logtrainer.html'));
});
